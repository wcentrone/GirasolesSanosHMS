...
const Button = ({ children, variant="primary", size="md", onClick=(_?:any)=>{}, disabled=false, icon=null, style={} }) => {
  const [hov, setHov] = useState(false);
  const variants = {
  ...
  return (
    <div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:16,marginBottom:24}}>
        {kpis.map((kpi,i)=>(
          <Card key={i} onClick={()=>{}} style={{padding:20,background:kpi.bg,border:`1px solid ${kpi.color}15`}}>
